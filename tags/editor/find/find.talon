...
^scout toggle case$: user.find_toggle_match_by_case()

^scout toggle word$: user.find_toggle_match_by_word()

^scout toggle regex$: user.find_toggle_match_by_regex()

^replace toggle case$: user.find_replace_toggle_preserve_case()
...
^pop dock <user.text>$: user.find_file(text)
